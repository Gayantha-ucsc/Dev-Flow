...
-- DEMO PROJECT
-- The admin is both Team Lead and Manager, .
INSERT INTO `Project` (name, description, created_by, workflow_template_id, deadline, status)
VALUES ('DevFlow Demo Project', 'Sample project used to demonstrate workflow stage management.', 1, NULL, '2027-01-31', 'active');

INSERT INTO `ProjectMember` (project_id, user_id, role, added_by, is_active) VALUES
(1, 1, 'team_lead', NULL, TRUE),
(1, 2, 'manager', NULL, TRUE),
(1, 7, 'developer', NULL, TRUE),
(1, 8, 'client', NULL, TRUE);

-- DEMO PAYMENT SCHEDULE (Project 1: Manager = ProjectMember 2, so log in as user 2 to manage it)
INSERT INTO `Stage` (project_id, name, sequence_order, status) VALUES
(1, 'Requirement Gathering', 1, 'completed'),
(1, 'Design', 2, 'in_progress'),
(1, 'Development', 3, 'not_started'),
(1, 'Delivery and Handoff', 4, 'not_started');

INSERT INTO `PaymentMilestone` (project_id, stage_id, created_by, description, amount, due_date, status) VALUES
(1, 1, 1, 'Kickoff deposit',        4000.00, '2026-10-05', 'paid'),
(1, 2, 1, 'Design approval',        6000.00, '2026-10-31', 'requested'),
(1, 3, 1, 'Development milestone',  8000.00, '2026-12-15', 'pending'),
(1, 4, 1, 'Final delivery payment', 5000.00, '2027-01-25', 'pending');
